...
gradebook table should be open 
    ...
    Element Should Be Enabled       xpath:/html/body/ng-include/div[2]/ui-view/div/div/div/div/div/div[2]/div/div/table/tbody/tr[1]/td[3]/button
    Element Should Be Enabled       xpath:/html/body/ng-include/div[2]/ui-view/div/div/div/div/div/div[2]/div/div/table/tbody/tr[2]/td[3]/button
    Element Should Contain          xpath:/html/body/ng-include/div[2]/ui-view/div/div/div/div/div/div[2]/div/div/table     Module 
check gradebook a 
    Click Element       xpath:/html/body/ng-include/div[2]/ui-view/div/div/div/div/div/div[2]/div/div/table/tbody/tr[1]/td[3]/button
...
check gradebook b 
    Click Element       xpath:/html/body/ng-include/div[2]/ui-view/div/div/div/div/div/div[2]/div/div/table/tbody/tr[2]/td[3]/button
    Element Should Be Visible       xpath:/html/body/ng-include/div[2]/ui-view/div/div/div/div/div/div[3]/div[1]/img
    Element Should Be Visible       xpath:/html/body/ng-include/div[2]/ui-view/div/div/div/div/div/div[3]/div[2]/img
    Element Should Be Visible       xpath:/html/body/ng-include/div[2]/ui-view/div/div/div/div/div/div[4]/div/*[name()="nvd3"]/*[name()="svg"]/*[name()="g"]/*[name()="g"]/*[name()="g"][3]/*[name()="g"]/*[name()="g"]/*[name()="g"]/*[name()="g"]/*[name()="g"][1]
    Element Should Be Visible       xpath:/html/body/ng-include/div[2]/ui-view/div/div/div/div/div/div[5]/div/div
